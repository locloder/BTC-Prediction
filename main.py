...
def load_news_data():
    ...
    news_file_path = "parsing/news.json"
    news_context = []
...
def predict_action():
    ...
    # Use parsing folder for temporary files
    temp_price_path = "parsing/temp_btc_prices.json"
    ...
    if consider_news_var.get():
        ...
        if news_context:
            temp_news_path = "parsing/temp_news.json"
            try:
                news_data = {
